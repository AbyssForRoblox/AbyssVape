  ...
  ;   \  ' .'  :  | \  \ ,'|   | ;    |   |  |-,              
   \   \   '|  |  '  '--'  :   ' |    '   :  ;/|              
    \   `  ;|  :  :        :   : :    |   |    \              
     :   \ ||  | ,'        |   | :    |   :   .'              
      '---" `--''          `---'.|    |   | ,'                
   vape/CustomModules/18303609742.lua by abyss 100%!                          `---`    `----'                  
 --]]                                                             
...
runFunction(function()
    local oplmao = GuiLibrary.ObjectsThatCanBeSaved.ExploitWindow.Api.CreateOptionsButton({
        Name = "Get Inf Spins",
